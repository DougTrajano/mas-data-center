    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] terms) throws Exception {
        try {
            ...
            if (model.inGrid(itox,itoy)) {
                Busca searchAlg = new AEstrela(); //chamada do algoritmo de busca
                ...
                //Nodo solution = new AEstrela(new MostraStatusConsole()).busca(new GridState(lini, lini,new Location(itox, itoy), model, "initial"));
